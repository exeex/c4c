...
function-body parameter-use authority row after accepted 734 Step 7.49.

## Why This Exists

Idea 734 can receive only structured LIR authority into typed Raw BIR. Its
latest accepted receiver packet, commit `44edfbacd`, consumed the closed-860
DirectScalar binary-`fsub` RHS row. The 734 completion gate remains unmet, but
...
- Inspect current LIR body-parameter producer and verifier behavior after the
  accepted DirectPointer and DirectScalar receipts through 734 Step 7.49.
...
- Reject selecting multiple rows, a generic body-parameter family, or any row
  already accepted by 734 through Step 7.49.
