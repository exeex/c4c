---
name: plan-lifecycle
description: Manage the c4c planning lifecycle across ideas/open/*.md, ideas/closed/*.md, plan.md, and plan_todo.md. Use when activating a plan from an open idea, executing an active plan, deactivating or switching plans, or closing a completed idea.
---
...
4. [`plan_todo.md`](/workspaces/c4c/plan_todo.md): execution-state scratchpad for the active plan
...
3. the agent implements from [`plan.md`](/workspaces/c4c/plan.md) and tracks progress in [`plan_todo.md`](/workspaces/c4c/plan_todo.md)
...
1. there is at most one active plan, represented by the pair [`plan.md`](/workspaces/c4c/plan.md) and [`plan_todo.md`](/workspaces/c4c/plan_todo.md)
2. every active [`plan.md`](/workspaces/c4c/plan.md) must name exactly one source idea under `ideas/open/`
3. [`plan_todo.md`](/workspaces/c4c/plan_todo.md) belongs only to the active [`plan.md`](/workspaces/c4c/plan.md)
4. durable design intent lives in `ideas/open/*.md`, not only in [`plan_todo.md`](/workspaces/c4c/plan_todo.md)
5. implementation progress lives in [`plan_todo.md`](/workspaces/c4c/plan_todo.md), not only in commit history
6. lifecycle state is primarily determined by file existence:
   - neither `plan.md` nor `plan_todo.md` exists: no active plan
...
2. check whether [`plan.md`](/workspaces/c4c/plan.md) and [`plan_todo.md`](/workspaces/c4c/plan_todo.md) exist
...
7. create or reset [`plan_todo.md`](/workspaces/c4c/plan_todo.md) for the new active plan
...
2. treat [`plan_todo.md`](/workspaces/c4c/plan_todo.md) as the mutable execution state
...
1. read [`plan.md`](/workspaces/c4c/plan.md) and [`plan_todo.md`](/workspaces/c4c/plan_todo.md)
...
4. remove or replace [`plan_todo.md`](/workspaces/c4c/plan_todo.md)
...
4. reset [`plan_todo.md`](/workspaces/c4c/plan_todo.md) to the new plan
...
3. delete [`plan_todo.md`](/workspaces/c4c/plan_todo.md)
