...
2. Check whether [`plan.md`](../plan.md) and [`todo.md`](../todo.md) already exist.
...
6. Near the top of [`plan.md`](../plan.md), state:
   - `Status: Active`
   - `Source Idea: ...`
7. Create or reset [`todo.md`](../todo.md) for the new active plan.
8. Ensure [`todo.md`](../todo.md) names:
   - `Status: Active`
   - `Source Idea: ...`
   - `Source Plan: plan.md`
