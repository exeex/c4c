...
1. Read the current active [`plan.md`](../plan.md) and [`plan_todo.md`](../plan_todo.md).
...
6. Reset [`plan_todo.md`](../plan_todo.md) to match the new active plan.

## Guardrails

1. Do not discard the old plan's execution history.
2. Do not merge old and new ideas into one ambiguous runbook.
3. Do not leave [`plan_todo.md`](../plan_todo.md) pointing at the wrong source idea.
