...
Refresh and resolve the still-open AArch64 variadic HFA/floating residual owner
without reopening adjacent repairs or chasing unrelated current failures.
...
`00204.c`, but its latest lifecycle note says the current focused subset passed
and no in-scope first bad fact was visible. The file remains under
