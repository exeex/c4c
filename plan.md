...
`00181`, and `00189`, with no old suspicious immediate-scale `mul` pattern
remaining. Closure is deferred because an acceptance-grade matching regression
guard has not accepted archival closure.
