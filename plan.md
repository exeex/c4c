...
materialized pointer store writeback, pointer-derived load/address scaling, or
ABI-wide aggregate work unless fresh generated-code evidence makes that
...
shape, and the latest refresh note reports `00181` plus adjacent guardrails
green. This runbook exists to refresh that conclusion from the current tree and
leave a usable proof basis for the next lifecycle decision.
