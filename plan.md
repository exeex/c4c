...
Resumed from: closed `ideas/closed/782_lir_vaarg_phi_input_result_identity_publication.md` at preserved Step 1.
...
- `ideas/closed/782_lir_vaarg_phi_input_result_identity_publication.md`
...
1. Start from the accepted producer handoffs: closed 775's selected logical
   RHS and ternary-arm results, and closed 782's GP/FP/AMD64 helper-input map,
   are authority facts, not text.
