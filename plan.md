...
Resumed After: blocker 861 closed in commit `aebb8713c` after implementation commit `df0e29445`
...
- Closed blocker 861 commits `df0e29445` and `aebb8713c`
...
- Last accepted progress for this idea's Step 1: none.
- Completed runbook steps: none.
- Return point: Step 1, `Select and publish one next body-parameter authority row`.
