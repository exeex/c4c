...
Activated From: parked open idea after idea 326 close rejection
...
Make any current recursive-call argument preservation first bad fact advance
...
- handoff notes for ideas 352, 353, 360, and 362 when evidence points outside
  this source idea
...
failures moved to adjacent owners. A later refresh showed `00176` and `00181`
green, but close was rejected by the strict monotonic regression gate. The
executor must first re-establish whether a live recursive/nested call value is
again the current first bad fact. If refreshed evidence belongs to a split
owner, record the evidence in `todo.md` and return for lifecycle routing
instead of widening this runbook.
...
### Step 1: Refresh Current Recursive Call Preservation Proof
