...
1. The current B4/B5 owners do not yet define non-local-return boundary facts,
   volatile/address-escape treatment, or the exact memory-home obligation.
   Step 2 must close these rules without adding exceptional CFG authority.
