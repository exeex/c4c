...
- Do not let F128 or `conversion.c` drive the umbrella. F128 is lowest priority
  unless fresh bucket evidence proves it blocks broad non-F128 coverage;
  eventual F128 support should be external soft-float ABI glue, not
