...
- immediate target:
  ...
  bounded second-local two-argument helper-call route by moving the remaining
  local-slot-fed rewrite variants in bounded sub-slices, starting with the
  second-local rewrite route
