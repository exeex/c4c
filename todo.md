...
(`x == y ? x + 8 - 3 + 5 : y + 11 - 4`, then `+ 6 - 2`) and keep the slice
within Step 2 conditional backend-route parity before considering the adjacent
post-add-sub-add follow-up.
