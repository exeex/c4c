...
Reactivated the backend inventory umbrella after closing focused idea 372.
Idea 372 resolved `00163` with no new full-suite failures.
...
removing the resolved `00163` fact from the current surface.
