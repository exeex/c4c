...
Run the post-298 residual inventory/classification packet from `plan.md` step
1. Start from the accepted idea-298 close context and classify remaining
backend-regex failures before splitting any focused implementation owner.
