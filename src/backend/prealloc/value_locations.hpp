...
[[nodiscard]] constexpr std::string_view prepared_value_freshness_proof_kind_name(
  ...
  switch (kind) {
    ...
    case PreparedValueFreshnessProofKind::SelectCarrierAliasAuthority:
...
[[nodiscard]] constexpr std::string_view prepared_value_freshness_source_rank_name(
  ...
  switch (rank) {
    ...
    case PreparedValueFreshnessSourceRank::DirectEdgePublication:
      return "direct_edge_publication";
    case PreparedValueFreshnessSourceRank::SelectCarrierAlias:
      return "select_carrier_alias";
...
struct PreparedCurrentBlockEntryPublication {
  ...
  bir::RouteIndexValidationStatus block_entry_publication_proof_status =
      bir::RouteIndexValidationStatus::MissingRecord;
  bir::Route4PublicationAvailabilityStatus block_entry_publication_compatibility_status =
