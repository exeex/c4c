...
#include "bir_memory_provenance.hpp"
#include "bir_local_array_semantic_gep.hpp"
...
class Route6CallBoundaryAdapter {
 public:
  Route6CallBoundaryAdapter() = default;
 ...
 private:
  explicit Route6CallBoundaryAdapter(Route6CallUseSourceIndex route6_index)
      : route6_index_(std::move(route6_index)) {}

  Route6CallUseSourceIndex route6_index_;

  friend Route6CallBoundaryAdapter make_bir_call_boundary_view(
...
[[nodiscard]] Route6CallUseSourceIndex route6_build_call_use_source_index(
    const Function& function);
[[nodiscard]] Route6CallBoundaryAdapter make_bir_call_boundary_view(
    const Function& function);
