...
const char* sse_binary_mnemonic(IntrinsicOp intrinsic) {
  switch (intrinsic) {
    ...
    case IntrinsicOp::Punpckhwd128:
      return "punpckhwd";
    default:
      throw std::logic_error("unexpected x86 intrinsic binary mnemonic request");
  }
}
...
const char* sse_unary_imm_mnemonic(IntrinsicOp intrinsic) {
  switch (intrinsic) {
    ...
    case IntrinsicOp::Psrldi128:
      return "psrld";
    default:
      throw std::logic_error("unexpected x86 intrinsic unary-imm mnemonic request");
  }
}
...
const char* sse_shuffle_mnemonic(IntrinsicOp intrinsic) {
  switch (intrinsic) {
    ...
    case IntrinsicOp::Pshufhw128:
      return "pshufhw";
    default:
      throw std::logic_error("unexpected x86 intrinsic shuffle mnemonic request");
  }
}
