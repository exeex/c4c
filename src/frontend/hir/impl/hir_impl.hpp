...
//
// Implementation map:
// - root build/type/function/lowering translation units include this index
// - impl/lowerer.hpp declares the Lowerer engine and phase-specific helpers
// - impl/expr/expr.hpp, impl/stmt/stmt.hpp, and impl/templates/templates.hpp
//   are subdomain indexes layered on top of impl/lowerer.hpp
// - impl/compile_time/compile_time.hpp is the private bridge to deferred
//   compile-time materialization state
...
NamespaceQualifier make_ast_node_ns_qual_for_owner_key(
    const Node* n,
    TextTable* link_name_texts = nullptr);
