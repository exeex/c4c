...
if(CLANG_EXECUTABLE)
  ...
  if(OBJDUMP_EXECUTABLE)
    ...
    c4c_add_backend_codegen_route_test(
      backend_codegen_route_riscv64_indirect_twenty_six_arg_param_call_defaults_to_asm
      SRC "${INTERNAL_C_TEST_ROOT}/backend_route_case/indirect_twenty_six_arg_param_call.c"
      TARGET_TRIPLE riscv64-unknown-linux-gnu
      OUT_TEXT "${CMAKE_BINARY_DIR}/internal_backend_route/indirect_twenty_six_arg_param_call_riscv64.s"
      REQUIRED_SNIPPETS ".globl call_param|call_param:|sd ra, 0(sp)|mv t0, a0|addi sp, sp, -144|lw t1, 168(sp)|sw t1, 0(sp)|lw t1, 176(sp)|sw t1, 8(sp)|lw t1, 184(sp)|sw t1, 16(sp)|lw t1, 192(sp)|sw t1, 24(sp)|lw t1, 200(sp)|sw t1, 32(sp)|lw t1, 208(sp)|sw t1, 40(sp)|lw t1, 216(sp)|sw t1, 48(sp)|lw t1, 224(sp)|sw t1, 56(sp)|lw t1, 232(sp)|sw t1, 64(sp)|lw t1, 240(sp)|sw t1, 72(sp)|lw t1, 248(sp)|sw t1, 80(sp)|lw t1, 256(sp)|sw t1, 88(sp)|lw t1, 264(sp)|sw t1, 96(sp)|lw t1, 272(sp)|sw t1, 104(sp)|lw t1, 280(sp)|sw t1, 112(sp)|lw t1, 288(sp)|sw t1, 120(sp)|lw t1, 296(sp)|sw t1, 128(sp)|li t1, 26|sw t1, 136(sp)|mv a0, a1|mv a1, a2|mv a2, a3|mv a3, a4|mv a4, a5|mv a5, a6|mv a6, a7|lw a7, 160(sp)|jalr ra, t0, 0|addi sp, sp, 144|ld ra, 0(sp)|addi sp, sp, 16|ret"
      FORBIDDEN_SNIPPETS "bir.func @call_param|define i32 @call_param"
    )

    c4c_add_backend_codegen_route_test(
      backend_codegen_route_riscv64_indirect_twenty_six_arg_local_call_defaults_to_asm
      SRC "${INTERNAL_C_TEST_ROOT}/backend_route_case/indirect_twenty_six_arg_local_call.c"
      TARGET_TRIPLE riscv64-unknown-linux-gnu
      OUT_TEXT "${CMAKE_BINARY_DIR}/internal_backend_route/indirect_twenty_six_arg_local_call_riscv64.s"
      REQUIRED_SNIPPETS ".globl call_local|call_local:|sd ra, 8(sp)|sd a0, 0(sp)|ld t0, 0(sp)|addi sp, sp, -144|lw t1, 168(sp)|sw t1, 0(sp)|lw t1, 176(sp)|sw t1, 8(sp)|lw t1, 184(sp)|sw t1, 16(sp)|lw t1, 192(sp)|sw t1, 24(sp)|lw t1, 200(sp)|sw t1, 32(sp)|lw t1, 208(sp)|sw t1, 40(sp)|lw t1, 216(sp)|sw t1, 48(sp)|lw t1, 224(sp)|sw t1, 56(sp)|lw t1, 232(sp)|sw t1, 64(sp)|lw t1, 240(sp)|sw t1, 72(sp)|lw t1, 248(sp)|sw t1, 80(sp)|lw t1, 256(sp)|sw t1, 88(sp)|lw t1, 264(sp)|sw t1, 96(sp)|lw t1, 272(sp)|sw t1, 104(sp)|lw t1, 280(sp)|sw t1, 112(sp)|lw t1, 288(sp)|sw t1, 120(sp)|lw t1, 296(sp)|sw t1, 128(sp)|li t1, 26|sw t1, 136(sp)|mv a0, a1|mv a1, a2|mv a2, a3|mv a3, a4|mv a4, a5|mv a5, a6|mv a6, a7|lw a7, 160(sp)|jalr ra, t0, 0|addi sp, sp, 144|ld ra, 8(sp)|addi sp, sp, 16|ret"
      FORBIDDEN_SNIPPETS "bir.func @call_local|define i32 @call_local"
    )
    ...
    set(riscv64_backend_unsupported_asm_route_stems
      ...
      two_param_select_eq_split_predecessor_add_phi_post_add_sub
      two_param_select_eq_split_predecessor_add_phi_post_add_sub_add
      two_param_select_eq_split_predecessor_deeper_affine_post_add_sub
      ...
      two_param_select_eq_split_predecessor_deeper_then_mixed_affine_post_add
      two_param_select_eq_split_predecessor_deeper_then_mixed_affine_post_add_sub
      two_param_select_eq_split_predecessor_deeper_then_mixed_affine_post_add_sub_add
      two_param_select_eq_split_predecessor_mixed_then_deeper_affine_post_add
      two_param_select_eq_split_predecessor_mixed_then_deeper_affine_post_add_sub
      two_param_select_eq_split_predecessor_deeper_affine_post_add
      two_param_select_eq_split_predecessor_deeper_affine_post_add_sub_add
      two_param_select_eq_split_predecessor_mixed_then_deeper_affine_post_add_sub_add
    )
