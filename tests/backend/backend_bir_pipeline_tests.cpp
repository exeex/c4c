...
c4c::codegen::lir::LirModule make_supported_x86_local_arg_call_lir_module() {
  ...
  main_fn.signature_text = "define i32 @main()\n";
  main_fn.entry = LirBlockId{0};
  main_fn.alloca_insts.push_back(LirAllocaOp{"%lv.value", "i32", "", 4});

  LirBlock main_entry;
  main_entry.id = LirBlockId{0};
  main_entry.label = "entry";
  main_entry.insts.push_back(LirStoreOp{"i32", "9", "%lv.value"});
  main_entry.insts.push_back(LirLoadOp{"%t0", "i32", "%lv.value"});
  main_entry.insts.push_back(LirCallOp{"%t1", "i32", "@add_two", "(i32)", "i32 %t0"});
...
c4c::codegen::lir::LirModule make_supported_x86_local_arg_call_lir_module_with_spacing() {
  auto module = make_supported_x86_local_arg_call_lir_module();
  auto& call =
...
c4c::codegen::lir::LirModule make_supported_x86_local_arg_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_local_arg_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.args_str = "  i32   %t0  ";
...
c4c::codegen::lir::LirModule make_supported_x86_two_arg_helper_call_lir_module() {
  ...
  main_entry.id = LirBlockId{0};
  main_entry.label = "entry";
  main_entry.insts.push_back(LirCallOp{"%t0", "i32", "@add_pair", "(i32, i32)", "i32 5, i32 7"});
  main_entry.terminator = LirRet{std::string("%t0"), "i32"};
  main_fn.blocks.push_back(std::move(main_entry));
...
c4c::codegen::lir::LirModule make_supported_x86_two_arg_helper_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_helper_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
...
c4c::codegen::lir::LirModule make_supported_x86_two_arg_second_local_arg_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_second_local_arg_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_second_local_arg_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_two_arg_second_local_arg_call_lir_module_with_spacing();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.callee_type_suffix = "( i32 , i32 )";
  return module;
...
c4c::codegen::lir::LirModule make_supported_x86_two_arg_second_local_rewrite_call_lir_module() {
  using namespace c4c::codegen::lir;
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_second_local_rewrite_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_second_local_rewrite_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_second_local_rewrite_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_two_arg_second_local_rewrite_call_lir_module_with_spacing();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.callee_type_suffix = "( i32 , i32 )";
  return module;
...
c4c::codegen::lir::LirModule make_supported_x86_two_arg_first_local_rewrite_call_lir_module() {
  using namespace c4c::codegen::lir;
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_first_local_rewrite_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_first_local_rewrite_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_first_local_rewrite_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_two_arg_first_local_rewrite_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.args_str = " i32   %t2 ,   i32 7 ";
...
c4c::codegen::lir::LirModule make_supported_x86_call_crossing_direct_call_lir_module() {
  using namespace c4c::codegen::lir;
...
c4c::codegen::lir::LirModule make_supported_x86_call_crossing_direct_call_lir_module_with_spacing() {
  auto module = make_supported_x86_call_crossing_direct_call_lir_module();
  auto& call =
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module() {
  using namespace c4c::codegen::lir;
  ...
  main_entry.insts.push_back(LirStoreOp{"i32", "7", "%lv.y"});
  main_entry.insts.push_back(LirLoadOp{"%t0", "i32", "%lv.x"});
  main_entry.insts.push_back(LirBinOp{"%t1", LirBinaryOpcode::Add, "i32", "%t0", "0"});
  main_entry.insts.push_back(LirStoreOp{"i32", "%t1", "%lv.x"});
  main_entry.insts.push_back(LirLoadOp{"%t2", "i32", "%lv.x"});
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module_with_spacing();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.callee_type_suffix = "( i32 , i32 )";
  return module;
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module() {
  using namespace c4c::codegen::lir;
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.args_str = " i32   %t2 ,   i32 %t3 ";
  return module;
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module_with_spacing();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.callee_type_suffix = "( i32 , i32 )";
  return module;
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module() {
  using namespace c4c::codegen::lir;
  ...
  main_entry.insts.push_back(LirStoreOp{"i32", "%t1", "%lv.x"});
  main_entry.insts.push_back(LirLoadOp{"%t2", "i32", "%lv.y"});
  main_entry.insts.push_back(LirBinOp{"%t3", LirBinaryOpcode::Add, "i32", "%t2", "0"});
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module_with_spacing() {
  auto module = make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
...
c4c::codegen::lir::LirModule
make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module_with_suffix_spacing() {
  auto module = make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module_with_spacing();
  auto& call =
      std::get<c4c::codegen::lir::LirCallOp>(module.functions.back().blocks.front().insts.back());
  call.callee_type_suffix = "( i32 , i32 )";
  return module;
...
void test_x86_direct_call_helper_accepts_local_arg_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_local_arg_call_lir_module(), c4c::backend::Target::X86_64);
  const auto rendered = c4c::backend::x86::try_emit_minimal_local_arg_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded single-local helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_two",
                  "the direct x86 call helper seam should still emit the helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_two:\n  mov eax, edi\n  add eax, 2\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded helper add body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 9\n  call add_two\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded local-slot-fed helper call through the native x86 path");
}

void test_x86_direct_call_helper_accepts_local_arg_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_local_arg_call_lir_module_with_spacing(), c4c::backend::Target::X86_64);
  const auto rendered = c4c::backend::x86::try_emit_minimal_local_arg_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded single-local helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 9\n  call add_two\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing and keep the native local-slot-fed helper call shape");
}

void test_x86_direct_call_helper_accepts_local_arg_call_slice_with_suffix_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_local_arg_call_lir_module_with_suffix_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered = c4c::backend::x86::try_emit_minimal_local_arg_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded single-local helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 9\n  call add_two\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing and keep the native local-slot-fed helper call shape");
}

void test_x86_direct_call_helper_accepts_two_arg_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_helper_call_lir_module(), c4c::backend::Target::X86_64);
  const auto rendered = c4c::backend::x86::try_emit_minimal_two_arg_helper_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded immediate/immediate two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the two-arg helper definition after the Step 4 ownership move");
...
void test_x86_direct_call_helper_accepts_two_arg_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_helper_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered = c4c::backend::x86::try_emit_minimal_two_arg_helper_call_module(prepared);
...
void test_x86_direct_call_helper_accepts_two_arg_second_local_arg_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      ...
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_second_local_arg_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded second-local two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the second-local two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded second-local two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded second-local helper call through the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_second_local_arg_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_second_local_arg_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_second_local_arg_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded second-local two-arg helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing while still lowering the bounded second-local helper call on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_second_local_arg_call_slice_with_suffix_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_second_local_arg_call_lir_module_with_suffix_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded second-local two-arg helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing while still lowering the bounded second-local helper call on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_second_local_rewrite_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_second_local_rewrite_call_lir_module(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_second_local_rewrite_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded second-local rewrite two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the second-local rewrite two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded second-local rewrite two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still fold the second-local rewrite back to the stored immediate before invoking the helper on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_second_local_rewrite_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_second_local_rewrite_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded second-local rewrite two-arg helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing while still folding the second-local rewrite back to the stored immediate");
}

void test_x86_direct_call_helper_accepts_two_arg_second_local_rewrite_call_slice_with_suffix_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_second_local_rewrite_call_lir_module_with_suffix_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded second-local rewrite two-arg helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing while still folding the second-local rewrite back to the stored immediate");
}

void test_x86_direct_call_helper_accepts_two_arg_first_local_rewrite_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_first_local_rewrite_call_lir_module(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_first_local_rewrite_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded first-local rewrite two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the first-local rewrite two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded first-local rewrite two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still fold the first-local rewrite back to the stored immediate before invoking the helper on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_first_local_rewrite_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_first_local_rewrite_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded first-local rewrite two-arg helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing while still folding the first-local rewrite back to the stored immediate");
}

void test_x86_direct_call_helper_accepts_two_arg_first_local_rewrite_call_slice_with_suffix_spacing() {
  const auto prepared =
      c4c::backend::prepare_lir_module_for_target(
          make_supported_x86_two_arg_first_local_rewrite_call_lir_module_with_suffix_spacing(),
          c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_first_local_rewrite_call_module(prepared);
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded first-local rewrite two-arg helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing while still folding the first-local rewrite back to the stored immediate");
}

void test_x86_direct_call_helper_accepts_call_crossing_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_call_crossing_direct_call_lir_module(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_call_crossing_direct_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded plain call-crossing helper family after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_one",
                  "the direct x86 call helper seam should still emit the call-crossing helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_one:\n  mov eax, edi\n  add eax, 1\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded call-crossing helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  push rbx\n  mov ebx, 5\n  mov edi, ebx\n  call add_one\n  add eax, ebx\n  pop rbx\n  ret\n",
                  "the direct x86 call helper seam should still preserve the source value across the bounded helper call on the native x86 path");
}

void test_x86_direct_call_helper_accepts_call_crossing_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_call_crossing_direct_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_call_crossing_direct_call_module(prepared);
...
void test_x86_direct_call_helper_accepts_two_arg_both_local_arg_call_slice() {
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the both-local two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded both-local two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still reload both locals before invoking the helper on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_arg_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_arg_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_both_local_arg_call_module(prepared);
...
void test_x86_direct_call_helper_accepts_two_arg_both_local_first_rewrite_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      ...
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_both_local_first_rewrite_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local first-rewrite two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the both-local first-rewrite two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded both-local first-rewrite two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still fold the first local rewrite while reloading the second local before invoking the helper on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_first_rewrite_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local first-rewrite two-arg helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing while still folding the first local rewrite and reloading the second local on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_first_rewrite_call_slice_with_suffix_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_first_rewrite_call_lir_module_with_suffix_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local first-rewrite two-arg helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing while still folding the first local rewrite and reloading the second local on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_second_rewrite_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_both_local_second_rewrite_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local second-rewrite two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the both-local second-rewrite two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded both-local second-rewrite two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still fold the second local rewrite while reloading the first local before invoking the helper on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_second_rewrite_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local second-rewrite two-arg helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing while still folding the second local rewrite and reloading the first local on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_second_rewrite_call_slice_with_suffix_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_second_rewrite_call_lir_module_with_suffix_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local second-rewrite two-arg helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing while still folding the second local rewrite and reloading the first local on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_double_rewrite_call_slice() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module(),
      c4c::backend::Target::X86_64);
  const auto rendered =
      c4c::backend::x86::try_emit_minimal_two_arg_both_local_double_rewrite_call_module(prepared);

  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local double-rewrite two-arg helper-call slice after ownership moves out of emit.cpp");
  expect_contains(*rendered, ".globl add_pair",
                  "the direct x86 call helper seam should still emit the both-local double-rewrite two-arg helper definition after the Step 4 ownership move");
  expect_contains(*rendered, "add_pair:\n  mov eax, edi\n  add eax, esi\n  ret\n",
                  "the direct x86 call helper seam should still lower the bounded both-local double-rewrite two-arg helper body on the native x86 path");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should still fold both local rewrites before invoking the helper on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_double_rewrite_call_slice_with_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module_with_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local double-rewrite two-arg helper-call slice even when typed-call spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call spacing while still folding both local rewrites on the native x86 path");
}

void test_x86_direct_call_helper_accepts_two_arg_both_local_double_rewrite_call_slice_with_suffix_spacing() {
  const auto prepared = c4c::backend::prepare_lir_module_for_target(
      make_supported_x86_two_arg_both_local_double_rewrite_call_lir_module_with_suffix_spacing(),
      c4c::backend::Target::X86_64);
  const auto rendered =
  ...
  expect_true(rendered.has_value(),
              "the direct x86 call helper seam should accept the bounded both-local double-rewrite two-arg helper-call slice when typed-call suffix spacing drifts");
  expect_contains(*rendered, "main:\n  mov edi, 5\n  mov esi, 7\n  call add_pair\n  ret\n",
                  "the direct x86 call helper seam should trim typed-call suffix spacing while still folding both local rewrites on the native x86 path");
}
...
void run_backend_bir_pipeline_tests() {
  ...
  RUN_TEST(test_x86_direct_call_helper_accepts_local_arg_call_slice_with_spacing);
  ...
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_second_local_rewrite_call_slice);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_second_local_rewrite_call_slice_with_spacing);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_second_local_rewrite_call_slice_with_suffix_spacing);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_first_local_rewrite_call_slice);
  ...
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_both_local_second_rewrite_call_slice);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_both_local_second_rewrite_call_slice_with_spacing);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_both_local_second_rewrite_call_slice_with_suffix_spacing);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_both_local_double_rewrite_call_slice);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_both_local_double_rewrite_call_slice_with_spacing);
  RUN_TEST(test_x86_direct_call_helper_accepts_two_arg_both_local_double_rewrite_call_slice_with_suffix_spacing);
