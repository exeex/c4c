...
if(NOT BASH_EXECUTABLE)
  message(FATAL_ERROR "bash is required for EASTL type_traits workflow")
endif()

set(WORKFLOW_DIR "${BINARY_DIR}/eastl_type_traits_simple")
set(OUT_LL "${WORKFLOW_DIR}/eastl_type_traits_simple.ll")
set(OUT_CLANG_BIN "${WORKFLOW_DIR}/eastl_type_traits_simple.host.bin")
set(OUT_C2LL_BIN "${WORKFLOW_DIR}/eastl_type_traits_simple.c4c.bin")
...
execute_process(
  COMMAND "${BASH_EXECUTABLE}" "-lc"
          "front_err=$(mktemp); back_err=$(mktemp); \
           ...
           \"${CLANG}\" -x ir \"${OUT_LL}\" -o \"${OUT_C2LL_BIN}\" 2>\"\${back_err}\"; \
           st_back=$?; \
