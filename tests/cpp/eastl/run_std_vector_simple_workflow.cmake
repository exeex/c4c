...
if(NOT BASH_EXECUTABLE)
  message(FATAL_ERROR "bash is required for EASTL std::vector workflow")
endif()

set(WORKFLOW_DIR "${BINARY_DIR}/eastl_std_vector_simple")
set(OUT_LL "${WORKFLOW_DIR}/std_vector_simple.ll")
set(OUT_CLANG_BIN "${WORKFLOW_DIR}/std_vector_simple.host.bin")
set(OUT_C2LL_BIN "${WORKFLOW_DIR}/std_vector_simple.c4c.bin")
...
message(STATUS "[PASS] EASTL std_vector_simple workflow")
