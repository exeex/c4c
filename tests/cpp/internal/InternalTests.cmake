...
add_test(
  ...
  COMMAND "${CMAKE_COMMAND}"
          ...
          "-DEXPECT_ERROR_SUBSTRING:STRING=parse_fn=parse_top_level_parameter_list"
          "-DEXPECT_STACK_SUBSTRING:STRING=[pdebug] stack: -> parse_top_level -> parse_next_template_argument -> try_parse_template_type_arg -> parse_next_template_argument -> try_parse_template_type_arg -> parse_top_level_parameter_list"
          -P "${INTERNAL_C_TEST_CMAKE_ROOT}/run_parser_debug_case.cmake"
)
